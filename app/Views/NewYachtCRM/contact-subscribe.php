						...
						<div class="row">
							<div class="col-12">
								<div class="page-title-box d-sm-flex align-items-center justify-content-between">
									<h4 class="mb-sm-0 font-size-18">Contact Subscribe</h4>

									<div class="page-title-right">
										<ol class="breadcrumb m-0">
											<li class="breadcrumb-item"><a href="javascript: void(0);">Admin</a></li>
											<li class="breadcrumb-item active">Contact Subscribe</li>
										</ol>
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="col-xl-12 col-lg-12">
										<table class="table table-bordered">
											...
											<tbody>
												<?php foreach ($subscribe as $contact) : ?>
													<tr>
														<td><?php echo $contact['id']; ?></td>
														<td><?php echo $contact['name']; ?></td>
														<td><?php echo $contact['email']; ?></td>
														<td><a href="<?= base_url('contact-subscribe/delete'.$contact['id']) ?>" onclick="alert('Do you want to delete?')" class="btn btn-danger">Delete</a></td>
													</tr>
												<?php endforeach; ?>
											</tbody>
										</table>
