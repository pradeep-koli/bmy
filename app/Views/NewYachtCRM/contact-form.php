						...
						<div class="row">
							<div class="col-12">
								<div class="page-title-box d-sm-flex align-items-center justify-content-between">
									<h4 class="mb-sm-0 font-size-18">Contact Form</h4>
											...
											<tbody>
												<?php foreach ($contactForm as $contact) : ?>
													<tr>
														...
														<td><?php echo $contact['ownerCustomer']; ?></td>
														<td><?php echo $contact['subject']; ?></td>
														<td><?php echo $contact['message']; ?></td>
														<td><a href="<?= base_url('contact/delete'.$contact['id']) ?>" onclick="alert('Do you want to delete?')" class="btn btn-danger">Delete</a></td>
													</tr>
												<?php endforeach; ?>
											</tbody>
										</table>
