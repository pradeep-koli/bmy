                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <?php if ($user['status'] == 'Approve' || $user['status'] == 'Denied'): ?>
                                                                    <form action="<?= base_url('/users/delete/' . $user['id']) ?>"
                                                                        method="post">
                                                                        <?= csrf_field(); ?>
                                                                        <button type="submit" class="btn btn-primary ms-2"
                                                                            onclick="alert('Do you want to delete?')">Delete</button>
                                                                    </form>
                                                                <?php else: ?>
                                                                    <form action="<?= base_url('/users/approve/' . $user['id']) ?>"
                                                                        method="post">
                                                                        <?= csrf_field(); ?>
                                                                        <button type="submit"
                                                                            class="btn btn-success">Approve</button>
                                                                    </form>
                                                                    <form action="<?= base_url('/users/deny/' . $user['id']) ?>"
                                                                        method="post">
                                                                        <?= csrf_field(); ?>
                                                            ...
                                                            <div class="d-flex">
                                                                <?php if ($user['status'] == 'approve' || $user['status'] == 'denied'): ?>
                                                                    <form action="<?= base_url('/users/delete/' . $user['id']) ?>"
                                                                        ...
                                                                        <?= csrf_field(); ?>
                                                                        <button type="submit"
                                                                            class="btn btn-primary ms-2">Delete</button>
                                                                    </form>
                                                                <?php else: ?>
                                                                    <form action="<?= base_url('/users/approve/' . $user['id']) ?>"
                                                                        method="post">
