					...
					<div class="col-12">
						...
						<div class="d-lg-flex justify-content-lg-between mb-1">
							...
							<div class="mb-2 mb-lg-0">
								...
								<!-- Location -->
								<p class="fw-bold mb-0"><i class="bi bi-geo-alt me-2"></i><?php echo $record['location']; ?>
								</p>
							</div>
						</div>
					</div>
						...
						<div class="vstack gap-5">
							...
							<div class="card bg-transparent">
								...
								<div class="card-body pt-4 p-0">
									<div class="row g-4">
										...
										<!-- Activities -->
										<div class="col-sm-6">
											<h6><i class="fa-solid fa-sailboat me-2"></i>Facilities</h6>
											<!-- List -->
											<ul class="list-group list-group-borderless mt-2 mb-0">
										...
										<div class="col-sm-6">
											...
											<!--	</li>-->
											<!--	<li class="list-group-item pb-0">-->
											<!--		<i class="fa-solid fa-check-circle text-success me-2"></i>Emergency Medical Services-->
											<!--	</li>-->
											<!--	<li class="list-group-item pb-0">-->
											<!--		<i class="fa-solid fa-check-circle text-success me-2"></i>24/7 Onboard Security Personnel-->
											<!--	</li>-->
											<!--	<li class="list-group-item pb-0">-->
											<!--		<i class="fa-solid fa-check-circle text-success me-2"></i>Comprehensive First Aid Kit-->
											<!--	</li>-->
											<!--</ul>-->
										...
										<div class="col-sm-6">
											<h6><i class="fa-solid fa-cogs me-2"></i>
												Facilities</h6>
											<!-- List -->
											<ul class="list-group list-group-borderless mt-2 mb-0">
							...
							?>
								...
								<div class="alert alert-warning" role="alert">
									<b>Similar Yacht Not Available</b>
								</div>
							<?php else: ?>
								<!-- Room START -->
							...
							<?php foreach ($price as $abc) : ?>
								<div class="card card-body border mt-4">
									...
									<div class="d-sm-flex justify-content-sm-between align-items-center mb-3">
										...
										<div>
											<h6 class="fw-normal mb-0"><?= $abc['packs']; ?> Pax / <?= $abc['hours']; ?> Hour</h6>
