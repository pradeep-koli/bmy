                                        ...
                                        <div class="col-sm-8 m-auto">
                                            ...
                                            <form method="post" action="<?php echo site_url('yacht/update-record' . $record['id']) ?>" enctype="multipart/form-data" id="uploadForm">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="time" name="start_time" value="<?php echo $record['start_time']; ?>" class="form-control">
                                                </div>

                                                <div class="mb-3">
                                                    <label for="date"
                                                        class="form-label">End Date</label>
                                                    <input type="time" name="end_time" value="<?php echo $record['end_time']; ?>" class="form-control">
                                                </div>
