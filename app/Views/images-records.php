...
<head>
    ...
    <meta charset="utf-8" />
    <title>Images Record</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo site_url('public/');?>assets/images/favicon.ico">

    <!-- DataTables -->
    <link href="<?php echo site_url('public/');?>assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo site_url('public/');?>assets/libs/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css" rel="stylesheet" type="text/css" />

    <!-- Responsive datatable examples -->
    <link href="<?php echo site_url('public/');?>assets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css" rel="stylesheet" type="text/css" /> 
...
<body data-topbar="dark">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Images Recors</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Users</a></li>
                                            <li class="breadcrumb-item active">ImagesRecors</li>
                                        </ol>
                                    </div>
                                            ...
                                            <tbody>
                                                <?php foreach($images as $data) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="<?= "uploads/mainContent/".$data['images']; ?>" height="50px" width="50px">
                                                        </td>
                                                        <td>
                                                            <div class="d-flex gap-3">
                                                                <a href="<?= base_url('yacht/edit-record'.$data['id']) ?>" class="text-success">
                                                                    <i class="mdi mdi-pencil font-size-18"></i>
                                                                </a> 
                                                                <a href="<?= base_url('yacht/delete-record'.$data['id']) ?>" class="text-danger">
    ...
    <!-- Mirrored from themesdesign.in/dason-django/layouts/default/tables-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Feb 2024 22:11:39 GMT -->
    </html>
