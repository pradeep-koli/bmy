                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 col-lg-8">
                                        ...
                                        <form method="post" class="py-5" action="<?= base_url('payment/insert');?>">
                                            ...
                                            <div class="row mb-4">
                                                <input type="text" name="bankAddress" class="form-control" placeholder="Bank Address">
                                            </div>

                                            <div class="row mb-4">
                                                <input type="text" name="ABA" class="form-control" placeholder="Routing (ABA)">
                                            </div>

                                            <div class="row mb-4">
                                                <input type="text" name="swiftCode" class="form-control" placeholder="SWIFT Code">
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                <input type="text" name="accountType" class="form-control" placeholder="Account type">
                                            </div>

                                            <div class="row mb-4">
                                                <input type="text" name="beneficiaryName" class="form-control" placeholder="Beneficiary name">
                                            </div>
