...
<!-- Plugins CSS -->
<link rel="stylesheet" type="text/css" href="<?php echo site_url('yachtProject/');?>assets/vendor/font-awesome/css/all.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo site_url('yachtProject/');?>assets/vendor/bootstrap-icons/bootstrap-icons.css">
<link rel="stylesheet" type="text/css" href="<?php echo site_url('yachtProject/');?>assets/vendor/tiny-slider/tiny-slider.css">
<link rel="stylesheet" type="text/css" href="<?php echo site_url('yachtProject/');?>assets/vendor/choices/css/choices.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo site_url('yachtProject/');?>assets/vendor/flatpickr/css/flatpickr.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo site_url('yachtProject/');?>assets/vendor/glightbox/css/glightbox.css">
...
<body>
	...
	<head>
		...
		<meta charset="utf-8">
		<meta name="description" content="Embark on an unforgettable journey on the seas with Book My Yacht, your premier destination for chartering luxury yachts worldwide. Explore our extensive fleet of yachts, tailored to suit every occasion and preference.">
		<meta name="keywords" content="book my yacht, luxury yacht charter, yacht rental, yacht charter company, yacht vacation, yacht experience, yacht rental prices, yacht destinations, yacht booking, yacht rental online, yacht charter for special occasions">
		...
		<script>
			!function(e){if(!window.pintrk){window.pintrk = function () {
				...
				pintrk('load', '2613037804331', {em: '<user_email_address>'});
				pintrk('page');
			</script>
			<noscript>
				<img height="1" width="1" style="display:none;" alt="i am dot"
				src="<?php echo site_url('yachtProject/');?>https://ct.pinterest.com/v3/?event=init&tid=2613037804331&pd[em]=<hashed_email_address>&noscript=1" />
				</noscript>
				<!-- end Pinterest Tag -->
				<meta name="p:domain_verify" content="00e1eaa31e500cd1accfb2cd56c834c9"/>
				...
				<div class="offcanvas-body form-control-bg-light d-flex flex-column px-3">
					...
					<form method="post" id="myForm" onsubmit="return validateForm()" action="<?= base_url('enquiryForm')?>">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" data-search-enabled="true" aria-label=".form-select-sm" id="userValid" name="name" oninput="userValidation()" required>
						...
						<div class="mb-3">
							...
							<input type="tel" id="phone" name="phone" class="form-control" data-search-enabled="true" aria-label=".form-select-sm" oninput="checkNumber3(this)" required>
							<span id="error3" class="text-danger"></span>
						</div>

						<div class="mb-3">
							<label class="form-label mb-0">Preferred Location</label>
							<input type="text" name="location" class="form-control" data-search-enabled="true" aria-label=".form-select-sm" required>
						</div>

						<div class="mb-3 dollar-input-group">
							<label class="form-label mb-0">Budget</label>
							<div class="input-wrapper">
								<input type="text" name="budget" class="form-control" data-search-enabled="true" aria-label=".form-select-sm" id="numberInput" name="budget" oninput="checkNumber2(this)" required>
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" data-search-enabled="true" aria-label=".form-select-sm" id="numberInput" name="people" oninput="checkNumber1(this)" / required>
						...
						<div class="text-center">
							<input type="submit" name="submit" id="submitBtn" class="btn btn-primary-soft w-100 mb-0" value="Raise an Enquiry">
						</div>
					</form>
				...
				<nav class="navbar navbar-dark-static navbar-expand-xl">
					<div class="container-fluid px-md-5">
						...
						<a class="navbar-brand" href="<?= base_url('/') ?>">
							<img class="navbar-brand-item" alt="Book My Yacht Logo" src="<?php echo site_url('yachtProject/');?>assets/images/bmy-logo.png" alt="logo">
						</a>
						<!-- Logo END -->
					...
					<div class="navbar-collapse collapse" id="navbarCollapse">
						<ul class="navbar-nav navbar-nav-scroll mx-auto">
							...
							<!-- Nav item Link -->
							<li class="nav-item"> <a class="nav-link" href="<?= base_url('us/yacht-list'); ?>">Yacht Rent</a> </li>
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu" aria-labelledby="listingMenu">	
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Motor Yachts</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Sailing Yachts</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Catamarans</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Trimarans</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Explorer Yachts</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Sports Yachts</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Luxury Yachts</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Trawler Yachts</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Classic Yachts</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Day Sailors</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Performance Yachts</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Fishing Yachts</a></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">Charter Yachts</a></li>
									<li> <hr class="dropdown-divider"></li>
									<li> <a class="dropdown-item" href="<?= base_url('us/yacht-list'); ?>">See More  </a> </li>
								</ul>
							</li>

							<!-- Nav item Link -->
							<li class="nav-item"> <a class="nav-link" href="<?= base_url('us/services');?>">Offers</a> </li>

							<!-- Nav item Link -->
							<li class="nav-item"> <a class="nav-link" href="<?= base_url('us/gallery');?>">Gallery</a> </li>
							<!-- Nav item Link -->
							<li class="nav-item"> <a class="nav-link" href="<?= base_url('us/about');?>">About</a> </li>

							<!-- Nav item Link -->
							<li class="nav-item"> <a class="nav-link" href="<?= base_url('us/contact'); ?>">Contact</a> </li>

						</ul>
					</div>
					<div class="nav flex-row ms-xl-auto">
						<button class="btn btn-sm mb-0 enquiry-top border border-white text-white" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBookstay"
					...
					<div class="col-xl-12 position-relative mt-n3 mt-xl-n9 mx-xl-4">
						<form class="card shadow rounded-3 position-relative p-4 pe-md-5 pb-5 pb-md-4">
							<div class="row">
								...
								<div class="col-sm-2">
									<div class="form-control-border form-control-transparent form-fs-md ">
										<div class="flex-grow-1">
											...
											<input type="text" name="booking_date"  id="datepicker" class="form-control" placeholder="booking date" style="padding: 15px 10px; margin-top: -20px;"> 
										</div>
									</div>
								</div>
										...
										<div class="flex-grow-1">
											...
											<div id="Guests">
												<div id="guestSection1" style="margin-top: -20px;">
													<select class="form-select js-choice" onchange="convertIfSelected(this, 'guestSection1')" style="padding-bottom: 15px; padding-top: 15px;">
														<option value="">Select</option>
										...
										<div class="flex-grow-1">
											...
											<div id="Cabins">
												<div id="guestSection2" style="margin-top: -20px;">
													<select class="form-select js-choice" onchange="convertIfSelected(this, 'guestSection2')" style="padding-bottom: 15px; padding-top: 15px;">
														<option value="">Select</option>
														<option value="1">1</option>
														<option value="2">2</option>
														<option value="3">3</option>
								...
								<div class="col-sm-2">
									<div class="form-control-border form-control-transparent form-fs-md ">
										<div class="flex-grow-1">
											...
											<select class="form-select js-choice">
												<option value="">Select</option>
												<option value="2">30 - 40 ft</option>
												<option value="3">40 - 50 ft</option>
												<option value="4">50 - 60 ft</option>
												<option value="5+">60 - 70 ft</option>					
												<option value="5+">70 - 80 ft</option>
												<option value="5+">80 - 90 ft</option>
												<option value="5+">90 - 100 ft</option>
												<option value="5+">Above 100 ft</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-2">
									<a href="<?= base_url('us/yacht-list');?>" class="btn search-top text-white rounded-pill">Search</a>
								</div>
								<style>
									.search-top{
										background-color: #061138;
						...
						foreach ($yacht as $abc) {
							...
							<div>
								<div class="card card-metro overflow-hidden">
									<img alt="38 Cruiser" src="<?= base_url('uploads/thumbnail/'.$abc['thumb-img']) ?>" alt="Book My Yacht" class="img-fluid" style="object-fit: cover; height: 400px;">
									<div class="card-img-overlay d-flex">
										<!-- Info -->
										<div class="card-text mt-auto">
											<h4><a href="<?= base_url('us/yacht-detail'.$abc['id']); ?>" class="text-white stretched-link"><?php echo $abc['yacht_type']; ?></a></h4>
								<!-- <button class="btn btn-link text-white p-0 mb-0">Explore More <i
									class="fa-solid fa-arrow-right-long fa-fw"></i>
								</button> -->

								<a href="<?= base_url('us/yacht-list')?>" class="btn btn-link text-white p-0 mb-0">Explore More <i
	...
	<div class="container" id="bestfacilities">
		<div class="row g-4 align-items-center">
			<div class="col-lg-6">
				...
				<p>We provide the best yachts that will make your time spent a memorable one. The yachts are quality and well-maintained.
				</p>
				<!-- Button -->
							...
							<li class="list-group-item">
								...
								<li class="list-group-item">
									<h6 class="fw-normal mb-0">
										<i class="fa-solid fa-person-swimming fa-fw text-primary me-2"></i>Swimming	Pool</h6>
									</li>

									<li class="list-group-item">
										<h6 class="fw-normal mb-0"><i
											class="fa-solid fa-person-shelter fa-fw text-primary me-2"></i> Private Space
										</h6>
									</li>

									<li class="list-group-item">
										<h6 class="fw-normal mb-0"><i
											class="fa-solid fa-utensils fa-fw text-primary me-2"></i>Food & Refreshment</h6>
										</li>
									</ul>
								</div>
											...
											<li class="list-group-item">
												...
												<li class="list-group-item">
													<h6 class="fw-normal mb-0">
														...
														<i class="fa-solid fa-shield-halved fa-fw text-primary me-2"></i>Safety Equipment</h6>
													</li>
												</ul>
											</div>
										</div>
											...
											<div class="tiny-slider arrow-round arrow-blur">
												...
												<div class="card bg-transparent">
													<div class="row g-4 align-items-center">
														...
														<div class="col-sm-6">
															<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/creatememories.png" class="img-fluid card-img" alt="...">
														</div>
														<div class="col-sm-6">
															<div class="card-body p-0">
																<h6 class="fw-normal mb-3" style="color:#061138">Create Memories
																</h6>
																<h4 class="card-title mb-3"><a href="<?= base_url('us/yacht-list')?>"
																	class="stretched-link">Premium Yacht Services</a></h4>
																	<a href="<?= base_url('us/yacht-list')?>" class="btn btn-link p-0">Explore Now <i
														...
														<div class="card bg-transparent">
															<div class="row g-4 align-items-center">
																<div class="col-sm-6">
																	<img src="<?php echo site_url('yachtProject/');?>assets/images/gif/21.jpg" class="img-fluid card-img" alt="...">
																...
																<div class="col-sm-6">
																	<div class="card-body p-0">
																		...
																		<h4 class="card-title mb-3"><a href="<?= base_url('us/contact');?>"
																			...
																			<a href="<?= base_url('us/contact')?>" class="btn btn-link p-0">Explore Now <i
																				class="bi bi-arrow-right"></i></a>
																			</div>
																		</div>
																	</div>
																...
																<div class="card bg-transparent">
																	<div class="row g-4 align-items-center">
																		<div class="col-sm-6">
																			<img src="<?php echo site_url('yachtProject/');?>assets/images/gif/22.jpg" class="img-fluid card-img" alt="...">

																		</div>
																		<div class="col-sm-6">
																			<div class="card-body p-0">
																				<h6 class="fw-normal mb-3" style="color:#061138">Aqua Adventure</h6>
																				<h4 class="card-title mb-3"><a href="<?= base_url('us/contact')?>" class="stretched-link">
																					Sailing
																				& Spa Services </a></h4>
																				<a href="<?= base_url('us/contact');?>" class="btn btn-link p-0">Explore Now <i
																					class="bi bi-arrow-right"></i></a>
						...
						<div class="row mb-4">
							<div class="col-xxl-12 mx-auto">
								<div class="d-sm-flex justify-content-between align-items-center ">
									<h2 class="mb-0">Our Favorite Yachts</h2>
									<a href="<?= base_url('us/yacht-list');?>" class="btn btn-dark mb-0 d-grid">See all yacht</a>
								</div>
							</div>
						</div>
					</div>
					<div class="tiny-slider arrow-round arrow-blur arrow-hover rounded-3 overflow-hidden">
						<div class="tiny-slider-inner" data-gutter="0" data-arrow="true" data-dots="false" data-items="1">
							...
							<div>
								...
								style="background-image:url(<?php echo site_url('yachtProject/');?>assets/images/yatch/extra-large.jpg); background-position: center left; background-size: cover;">
								...
								<div class="row mt-auto justify-content-end z-index-9">
									<div class="col-md-8 col-xl-6 col-xxl-4">
										<div class="card-body bg-mode rounded p-3 p-md-5 m-2 m-lg-6">
											...
											<!-- Buttons -->
											<a href="<?= base_url('us/yacht-detail');?>1" class="btn btn-light mb-0">Reserve <i
							...
							<!-- Card item START -->
							<div>
								<div class="card overflow-hidden rounded-0 h-600px" style="background-image:url(<?php echo site_url('yachtProject/');?>assets/bmy/yachts/wp3410763-luxury-yachts-wallpapers.jpg); background-position: center left; background-size: cover;">
									...
									<div class="row mt-auto justify-content-end z-index-9">
										<div class="col-md-8 col-xl-6 col-xxl-4">
											<div class="card-body bg-mode rounded p-3 p-md-5 m-2 m-lg-6">
												...
												<p class="mb-3">Having an overall length of 36 meters, the motor yacht Eternity With a 7.2 m beam, 2.25 m draught, and 146 GT of space, the superyacht is quite large. </p>
												...
												<!-- Buttons -->
												<a href="<?= base_url('us/yacht-detail');?>2" class="btn btn-light mb-0">Reserve <i
													class="fa-solid fa-arrow-right-long"></i></a>
												</div>
											</div>
										</div>
								...
								<div>
									<div class="card overflow-hidden rounded-0 h-600px"
									style="background-image:url(<?php echo site_url('yachtProject/');?>assets/bmy/yachts/4243055.jpg); background-position: center left; background-size: cover;">
									<!-- Background dark overlay -->
									<div class="bg-overlay bg-dark opacity-3"></div>
									...
									<div class="row mt-auto justify-content-end z-index-9">
										<div class="col-md-8 col-xl-6 col-xxl-4">
											<div class="card-body bg-mode rounded p-3 p-md-5 m-2 m-lg-6">
												...
												<p class="mb-3">A motor yacht with a 31.7 m overall length is called Illusions.  The superyacht has a volume of 143 GT, a beam of 6.12 m, and a draught of 2.36 m.</p>
												...
												<ul class="list-inline hstack flex-wrap gap-2 mb-3">
													...
													<li class="list-inline-item h6 fw-normal mb-0">
														<i class="bi bi-check-lg text-success me-1"></i>Wet Bar and BBQ grill
													</li>
												</ul>

												<!-- Buttons -->
												<a href="<?= base_url('us/yacht-detail')?>3" class="btn btn-light mb-0">Reserve <i
													class="fa-solid fa-arrow-right-long"></i></a>
												</div>
											</div>
										</div>
			...
			<div class="container-fluid px-lg-5">
				...
				<div class="row g-4">						
					<div class="col-xl-6" id="happyMoments2">
						...
						style="background-image:url(<?php echo site_url('yachtProject/');?>assets/images/yatch/yatchcouple.png); 
				...
				<div class="col-xl-6 m-xxl-auto">
					<div class="card card-body bg-transparent p-xxl-6">
						<h3>We make your yacht booking better than others ?</h3>
						...
						<div class="row g-4">
							<div class="col-12">
								<div class="d-flex">
									<div class="icon-lg bg-primary bg-opacity-10 flex-shrink-0 text-danger rounded-circle">
										<!--<i class="fa-regular fa-thumbs-up"></i>-->
										<i class="fa-solid fa-calendar-days icon-color" style="padding-top :15px; color: #061138;"></i>
									</div>
									<div class="ps-3">
										<h5 class="mt-2">Booking Made Easy</h5>
										<p class="mb-0">Explore your maritime dreams effortlessly through our vast selection. We make your bookings much easier with plenty of options available, ensuring your journey on the water is tailored to perfection.</p>
									</div>
								</div>
							</div>
							<div class="col-12">
								<div class="d-flex">
									...
									<i class="fa-solid fa-shield icon-color" style="padding-top :15px; color: #061138;"></i>
								</div>
								<div class="ps-3">
									<h5 class="mt-2">Secure Payments</h5>
									<p class="mb-0">Rest assured, your payments are securely handled for a seamless experience. Our priority is to ensure the security of our customers' transactions, making the process effortless and worry-free.</p>
								</div>
							</div>
						</div>
						<div class="col-12">
							<div class="d-flex">
								<div class="icon-lg bg-primary bg-opacity-10 flex-shrink-0 rounded-circle">
									<i class="fas fa-headset" style="color: #0e2884;"></i></div>
									<div class="ps-3">
										<h5 class="mt-2">24/7 Supports</h5>
										<p class="mb-0">Count on us for comprehensive support in every possible way. We are dedicated to assisting you in every aspect, ensuring a seamless experience at every step.
										</p>
									</div>
								</div>
							</div>
						...
						<div class="flip-box">
							<div class="flip-box-inner">
								<div class="flip-box-front">
									<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/yacht2.png" alt="Paris" width="100">
								</div>
				...
				<div class="col-sm-4">
					<center>
						<div class="flip-box">
							<div class="flip-box-inner">
								<div class="flip-box-front">
									<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/boatrace.png" alt="Book My Yacht" width="50">
								</div>
								<div class="flip-box-back">
									<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/boatrace.png" alt="Book My Yacht" width="50">
								</div>
				...
				<div class="col-sm-4">
					<center>
						<div class="flip-box">
							<div class="flip-box-inner">
								<div class="flip-box-front">
									<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/mbag.png" alt="Book My Yacht" width="50">
								</div>
								<div class="flip-box-back">
									<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/mbag.png" alt="Book My Yacht" width="50">
								</div>
	...
	<section>
		<div class="container-fluid">
			...
			<div class="tiny-slider arrow-round arrow-blur arrow-hover rounded-3 overflow-hidden">
				...
				<div>
					<a data-glightbox="" data-gallery="gallery" href="<?php echo site_url('yachtProject/');?>assets/images/yatch/05.jpg">
						<div class="card card-element-hover card-overlay-hover overflow-hidden">
							<img src="<?php echo site_url('yachtProject/');?>assets/images/yatch/05.jpg" class="rounded-3" alt="Book My Yacht">
				...
				<div>
					<a data-glightbox="" data-gallery="gallery" href="<?php echo site_url('yachtProject/');?>assets/images/yatch/02.jpg">
						<div class="card card-element-hover card-overlay-hover overflow-hidden">
							<img src="<?php echo site_url('yachtProject/');?>assets/images/yatch/02.jpg" class="rounded-3" alt="Book My Yacht">
							<div class="hover-element w-100 h-100">
								<i
								class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
							</div>
				...
				<div>
					<a data-glightbox="" data-gallery="gallery" href="<?php echo site_url('yachtProject/');?>assets/images/yatch/08.jpg">
						<div class="card card-element-hover card-overlay-hover overflow-hidden">
							<!-- Image -->
							<img src="<?php echo site_url('yachtProject/');?>assets/images/yatch/08.jpg" class="rounded-3" alt="Book My Yacht">
							<!-- Full screen button -->
							<div class="hover-element w-100 h-100">
								<i
								class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
				...
				<div>
					<a data-glightbox="" data-gallery="gallery" href="<?php echo site_url('yachtProject/');?>assets/images/gallery/y25.jpg">
						<div class="card card-element-hover card-overlay-hover overflow-hidden">
							<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/y25.jpg" class="rounded-3" alt="Book My Yacht">
							<div class="hover-element w-100 h-100">
				...
				<div>
					<a data-glightbox="" data-gallery="gallery" href="<?php echo site_url('yachtProject/');?>assets/images/gallery/06yatch.jpeg">
						<div class="card card-element-hover card-overlay-hover overflow-hidden">
							<!-- Image -->
							<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/06yatch.jpeg" class="rounded-3" alt="Book My Yacht">
							<!-- Full screen button -->
							<div class="hover-element w-100 h-100">
								<i
								class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
				...
				<!-- Slider item -->
				<div>
					<a data-glightbox="" data-gallery="gallery" href="<?php echo site_url('yachtProject/');?>assets/images/gallery/05yatch.jpeg">
						<div class="card card-element-hover card-overlay-hover overflow-hidden">
							<!-- Image -->
							<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/05yatch.jpeg" class="rounded-3" alt="Book My Yacht">
							<!-- Full screen button -->
							<div class="hover-element w-100 h-100">
								<i
								class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
				...
				<!-- Slider item -->
				<div>
					<a data-glightbox="" data-gallery="gallery" href="<?php echo site_url('yachtProject/');?>assets/images/gallery/eMOTION-81.jpg">
						<div class="card card-element-hover card-overlay-hover overflow-hidden">
							<!-- Image -->
							<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/eMOTION-81.jpg" class="rounded-3" alt="Book My Yacht">
							<!-- Full screen button -->
							<div class="hover-element w-100 h-100">
								<i
								class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
				...
				<div>
					<a data-glightbox="" data-gallery="gallery" href="<?php echo site_url('yachtProject/');?>assets/images/gallery/09yatch.jpeg">
						<div class="card card-element-hover card-overlay-hover overflow-hidden">
							<!-- Image -->
							<img src="<?php echo site_url('yachtProject/');?>assets/images/gallery/09yatch.jpeg" class="rounded-3" alt="Book My Yacht">
							<!-- Full screen button -->
							<div class="hover-element w-100 h-100">
							</div>
						</div>
...
<footer class="footer" style="background-color: red;">
	<div class="footer-item">
		...
		<p class="mb-2">
			<a href="#" class="text-muted text-primary-hover"><i class="bi bi-telephone me-2"></i>&nbsp;(888) 9199-BMY <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(888) 919-9269
			</a>
		</p>
		<p class="mb-0"><a href="mailto:booking@bookmyyacht.us" class="text-muted text-primary-hover"><i class="bi bi-envelope me-2"></i>&nbsp;booking@bookmyyacht.us</a></p>
	</div>
	<div class="footer-item">
	...
	<div class="footer-item">
		...
		<ul class="list-inline mb-0 mt-3">
			<li class="list-inline-item"> <a href="#"><img src="<?php echo site_url('yachtProject/');?>assets/images/element/visa.svg" width="50px" alt="Book My Yacht"></a></li>
			<li class="list-inline-item"> <a href="#"><img src="<?php echo site_url('yachtProject/');?>assets/images/element/mastercard.svg" width="50px" alt="Book My Yacht"></a></li>
		</ul>
	</div>
