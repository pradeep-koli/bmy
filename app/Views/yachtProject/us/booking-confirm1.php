			...
			<div class="row">
				<div class="col-md-10 col-xl-10 mx-auto">
					...
					<div class="card shadow">
						<!-- Image -->
						<img src="<?= site_url('YACHTBookingPages/') ?>assets\images\Yacht Images\Classic Yachts\classicYacht-transformed.jpeg"class="img-fluid rounded" alt="yacht images" style="height: 350px; width: 100%; object-fit: contain;">
						...
						<div class="card-body text-center p-4">
							...
							<!-- Second title -->
							<h5 class="text-primary mb-4">Beautiful Classic Yacht</h5>
								...
								<div class="col-lg-5">
									<ul class="list-group list-group-borderless">
										...
										<li class="list-group-item d-sm-flex justify-content-between align-items-center">
											...
											<span class="h6 fw-normal mb-0">CY-001</span>
										</li>

										<li class="list-group-item d-sm-flex justify-content-between align-items-center">
											<span class="mb-0"><i class="fa-solid fa-sailboat me-2"></i></i>Yacht Type:</span>
											<span class="h6 fw-normal mb-0">Classic Yacht</span>
										</li>

										<li class="list-group-item d-sm-flex justify-content-between align-items-center">
											<span class="mb-0"><i class="fa-solid fa-sailboat me-2"></i></i>Yacht Name:</span>
											<span class="h6 fw-normal mb-0">Sea Breeze</span>
										</li>

										<li class="list-group-item d-sm-flex justify-content-between align-items-center">
											<span class="mb-0"><i class="bi bi-person fa-fw me-2"></i>Builder Name:</span>
											<span class="h6 fw-normal mb-0">Jonson Steve</span>
										</li>

										<li class="list-group-item d-sm-flex justify-content-between align-items-center">
											<span class="mb-0">
												<i class="fa-solid fa-gauge me-2"></i>Maximum Speed:</span>
												<span class="h6 fw-normal mb-0">10 knots</span>
											</li>

											<li class="list-group-item d-sm-flex justify-content-between align-items-center">
												<span class="mb-0"><i class="fa-solid fa-ruler-horizontal me-2"></i>Yacht Length</span>
												<span class="h6 fw-normal mb-0">100 feet</span>
											</li>
										</ul>
									</div>
									...
									<div class="col-lg-5">
										<ul class="list-group list-group-borderless">
											...
											<li class="list-group-item d-sm-flex justify-content-between align-items-center">
												...
												<span class="h6 fw-normal mb-0">$500</span>
											</li>
											...
											<li class="list-group-item d-sm-flex justify-content-between align-items-center">
												...
												<span class="h6 fw-normal mb-0">6</span>
											</li>
										</ul>
									</div>
								</div>
