	...
	<section class="form-page">
		<div class="container">
			<div class="row py-3">
				<div class="col-md-8">
					<!-- Form START -->
					<h3 class="text-primary">Booking Form</h3>
					<form method="post" id="myForm" onsubmit="return validateForm()" class="py-3" action="<?= base_url('booking-confirm')?>">
						<?= csrf_field ()?>
						...
						<div class="form-group row py-2">
							...
							<div class="col-sm-9">
								<input type="submit" name="submit" value="Submit" class="btn btn-primary py-2 fw-bold w-25">
