...
<body>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="form-group col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                        <div class="field-inner">
                                            ...
                                            <select name="yacht_type" id="type" class="custom-select-box">
                                                <?php
                                                if (isset($filter)) {
                                                    if ($filter['yachtType'] == NULL) {
                                                        echo "<option value=''>Select Yacht</option>";
                                                    } else {
                                                        echo "<option id='typedel'>" . $filter['yachtType'] . "</option>";
                                                    }
                                                }
                                                ?>
                                    ...
                                    <div class="form-group col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                        <div class="field-inner">
                                            ...
                                            <select name="yacht_length" class="custom-select-box">
                                                <?php
                                                if (isset($filter)) {
                                                    if ($filter['yachtLength'] == NULL) {
                                                        echo "<option  value=''>Select Length</option>";
                                                    } else {
                                                        echo "<option id='lendel'>" . $filter['yachtLength'] . "</option>";
                                                    }
                                                }
                                                ?>
                                    ...
                                    <div class="form-group col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                        <div class="field-inner">
                                            ...
                                            if (isset($filter)) {
                                                if ($filter['yachtPrice'] == NULL) {
                                                    echo "value=''";
                                                } else {
                                                    echo "value='" . $filter['yachtPrice'] . "'";
                                                }
                                            }
                                            ?>
                        ...
                        <div class="filter-box">
                            <div class="form-group">
                                <div class="field-inner">
                                    ...
                                    <select id="sortOrder" name="sortOrder" onchange="sortYachts()">
                                    ...
                                    <script>
                                        ...
                                        function sortYachts() {
                                            ...
                                            const yachts = Array.from(yachtList.getElementsByClassName('rental-block'));
                                            ...
                                            yachtList.innerHTML = '';
                                            yachts.forEach(yacht => yachtList.appendChild(yacht));
                                        }
                                    </script>
                                    <script
                                        src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
                        ...
                        <div class="rental-block col-lg-4 col-md-6 col-sm-12" data-price="<?= $abc['price']; ?>">
                            <div class="inner-box">
                                ...
                                <div class="title-box">
                                    ...
                                    <h4><a href="<?= base_url('us/yacht-detail' . $abc['id']) ?>"><?= $abc['hname']; ?></a>
                                    </h4>
    ...
    <script>
        ...
        $totalPages = 10; // Assume you have 10 pages for demonstration
        
        echo '<ul class="styled-pagination">';
        for ($page = 1; $page <= $totalPages; $page++) {
            $activeClass = ($page === $currentPage) ? 'active' : '';
            echo "<li class=\"$activeClass\"><a href=\"?page=$page\">$page</a></li>";
        }
        echo '</ul>';
        ?>
