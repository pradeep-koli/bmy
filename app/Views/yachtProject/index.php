	...
	<div class="offcanvas offcanvas-w-500px offcanvas-end" tabindex="-1" id="offcanvasBookstay"
		...
		<div class="offcanvas-body form-control-bg-light d-flex flex-column px-3">
			...
			<form method="post" id="myForm" onsubmit="return validateForm()" action="<?= base_url('enquiryForm') ?>">
				...
				<div class="mb-3">
					<label class="form-label mb-0">Inquiry</label>
		...
		<div class="filter">
			<div class="row">
				<div class="col-xl-12 position-relative mt-n3 mt-xl-n9 mx-xl-4">
					<form class="card shadow rounded-3 position-relative p-4 pe-md-5 pb-5 pb-md-4" method="get"
						action="<?= base_url('filter') ?>">
						<?= csrf_field(); ?>
					...
					<div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-dots="false"
						...
						<div>
							<div class="card card-metro overflow-hidden">
								<img alt="38 Cruiser" src="<?= base_url() ?>public/assets/images/cruise-gallary/0101.jpg"
									alt="Book My Yacht" class="img-fluid" style="object-fit: cover; height: 400px;">
								<div class="card-img-overlay d-flex">
									<!-- Info -->
									<div class="card-text mt-auto">
										<h4><a href="<?= base_url() ?>us/cruise"
												class="text-white stretched-link">Cruise</a>
										</h4>
										<a href="<?= base_url('us/cruise') ?>"
						...
						<div>
							<div class="card card-metro overflow-hidden">
								<img alt="38 Cruiser" src="<?= base_url() ?>public/assets/images/yacht-images/catamaranYachtMain.jpg"
									alt="Book My Yacht" class="img-fluid" style="object-fit: cover; height: 400px;">
								<div class="card-img-overlay d-flex">
									<!-- Info -->
									<div class="card-text mt-auto">
						...
						<div>
							<div class="card card-metro overflow-hidden">
								<img alt="38 Cruiser" src="<?= base_url() ?>public/assets/images/yacht-images/MotorYachtMain.jpg"
									alt="Book My Yacht" class="img-fluid" style="object-fit: cover; height: 400px;">
								<div class="card-img-overlay d-flex">
									<!-- Info -->
									<div class="card-text mt-auto">
						...
						<div>
							<div class="card card-metro overflow-hidden">
								<img alt="38 Cruiser" src="<?= base_url() ?>public/assets/images/yacht-images/LuxuryYachtMain.jpg"
									alt="Book My Yacht" class="img-fluid" style="object-fit: cover; height: 400px;">
								<div class="card-img-overlay d-flex">
									<!-- Info -->
									<div class="card-text mt-auto">
					...
					<div class="tiny-slider-inner" data-gutter="0" data-arrow="true" data-dots="false" data-items="1">
						...
						<div>
							<div class="card overflow-hidden rounded-0 h-600px"
								style="background-image:url(<?php echo site_url(); ?>uploads/thumbnail/Fullsmall.jpg); background-position: center left; background-size: cover;">
								...
								<div class="row mt-auto justify-content-end z-index-9">
									<div class="col-md-8 col-xl-6 col-xxl-4">
										<div class="card-body bg-mode rounded p-3 p-md-5 m-2 m-lg-6">
											<!-- Title -->
											<h4>Private Reserve</h4>

											<!-- Content -->
											<ul class="nav h6 fw-light nav-divider mb-2 mb-sm-3">
												<li class="nav-item">20.4 m (67'0)</li>
											</ul>

											<p class="mb-3">
												The Private Reserve is a stunning luxury Italian motoryacht, meticulously built by Monte Fino. This 67-foot yacht boasts a spacious beam of 18.5 feet.
											</p>

											<!-- List -->
											<ul class="list-inline hstack flex-wrap gap-2 mb-3">
												<li class="list-inline-item h6 fw-normal mb-0">
													<i class="bi bi-check-lg text-success me-1"></i>Modern Kitchen
												</li>
												<li class="list-inline-item h6 fw-normal mb-0">
													<i class="bi bi-check-lg text-success me-1"></i>Room Service
												</li>
											</ul>

											<!-- Buttons -->
											<a href="<?= base_url('yacht-detail'); ?>14"
						...
						<div>
							<div class="card overflow-hidden rounded-0 h-600px"
								style="background-image:url(<?php echo site_url('yachtProject/'); ?>assets/images/yatch/CustomLine95ft.jpg); background-position: center left; background-size: cover;">
								...
								<div class="row mt-auto justify-content-end z-index-9">
									<div class="col-md-8 col-xl-6 col-xxl-4">
										<div class="card-body bg-mode rounded p-3 p-md-5 m-2 m-lg-6">
											<!-- Title -->
											<h4>Custom Line Yacht</h4>

											<!-- Content -->
											<ul class="nav h6 fw-light nav-divider mb-2 mb-sm-3">
												<li class="nav-item">28.9 m (95'1")</li>
											</ul>

											<p class="mb-3">Wide beam of 7.5 meters, the Custom Line 95 provides expansive living spaces, including a beautiful sun deck, stylish salon, and a modern galley. </p>

											<!-- List -->
											<ul class="list-inline hstack flex-wrap gap-2 mb-3">
												<li class="list-inline-item h6 fw-normal mb-0">
													<i class="bi bi-check-lg text-success me-1"></i>Bluetooth Sound System
												</li>
												<li class="list-inline-item h6 fw-normal mb-0">
													<i class="bi bi-check-lg text-success me-1"></i>Fishing Equipment
												</li>
												<li class="list-inline-item h6 fw-normal mb-0">
													<i class="bi bi-check-lg text-success me-1"></i>Paddle Board
												</li>
											</ul>

											<!-- Buttons -->
											<a href="<?= base_url('yacht-detail'); ?>841"
												class="btn btn-light mb-0">Reserve <i
													class="fa-solid fa-arrow-right-long"></i></a>
										</div>
									</div>
						...
						<div>
							<div class="card overflow-hidden rounded-0 h-600px"
								style="background-image:url(<?php echo site_url('yachtProject/'); ?>assets/images/yatch/85ftWally03.jpg); background-position: center left; background-size: cover;">
								<!-- Background dark overlay -->
								<div class="bg-overlay bg-dark opacity-3"></div>
								...
								<div class="row mt-auto justify-content-end z-index-9">
									<div class="col-md-8 col-xl-6 col-xxl-4">
										<div class="card-body bg-mode rounded p-3 p-md-5 m-2 m-lg-6">
											...
											<!-- Content -->
											<ul class="nav h6 fw-light nav-divider mb-2 mb-sm-3">
												<li class="nav-item">25.9 m (85'0")</li>
											</ul>

											<p class="mb-3">Beam of 6.4 meters, the Wally 85 provides ample deck space and an incredibly spacious interior, featuring large windows that offer panoramic views of the sea.</p>
											...
											<ul class="list-inline hstack flex-wrap gap-2 mb-3">
												...
												<li class="list-inline-item h6 fw-normal mb-0">
													<i class="bi bi-check-lg text-success me-1"></i>Cooler/ Ice/ Sodas/ Water and Towels
													grill
												</li>
											</ul>

											<!-- Buttons -->
											<a href="<?= base_url('yacht-detail') ?>840"
												class="btn btn-light mb-0">Reserve <i
													class="fa-solid fa-arrow-right-long"></i></a>
										</div>
									</div>
					...
					<div class="tiny-slider-inner d-flex align-items-end" data-autoplay="true" data-edge="2"
						...
						<div>
							<a data-glightbox="" data-gallery="gallery"
								href="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/01.jpg">
								<div class="card card-element-hover card-overlay-hover overflow-hidden">
									<img src="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/01.jpg"
						...
						<div>
							<a data-glightbox="" data-gallery="gallery"
								href="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/02.jpg">
								<div class="card card-element-hover card-overlay-hover overflow-hidden">
									<img src="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/02.jpg"
										class="rounded-3" alt="Book My Yacht">
									<div class="hover-element w-100 h-100">
										<i
											class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
						...
						<div>
							<a data-glightbox="" data-gallery="gallery"
								href="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/03.jpg">
								<div class="card card-element-hover card-overlay-hover overflow-hidden">
									<img src="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/03.jpg"
										class="rounded-3" alt="Book My Yacht">
									<div class="hover-element w-100 h-100">
										<i
											class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
						...
						<div>
							<a data-glightbox="" data-gallery="gallery"
								href="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/04.jpg">
								<div class="card card-element-hover card-overlay-hover overflow-hidden">
									<img src="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/04.jpg"
										class="rounded-3" alt="Book My Yacht">
									<div class="hover-element w-100 h-100">
										<i
											class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
						...
						<div>
							<a data-glightbox="" data-gallery="gallery"
								href="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/05.jpg">
								<div class="card card-element-hover card-overlay-hover overflow-hidden">
									<img src="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/05.jpg"
										class="rounded-3" alt="Book My Yacht">
									<div class="hover-element w-100 h-100">
										<i
											class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
						...
						<div>
							<a data-glightbox="" data-gallery="gallery"
								href="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/06.jpg">
								<div class="card card-element-hover card-overlay-hover overflow-hidden">
									<img src="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/06.jpg"
										class="rounded-3" alt="Book My Yacht">
									<div class="hover-element w-100 h-100">
										<i
											class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
						...
						<div>
							<a data-glightbox="" data-gallery="gallery"
								href="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/07.jpg">
								<div class="card card-element-hover card-overlay-hover overflow-hidden">
									<img src="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/07.jpg"
										class="rounded-3" alt="Book My Yacht">
									<div class="hover-element w-100 h-100">
										<i
											class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
						...
						<div>
							<a data-glightbox="" data-gallery="gallery"
								href="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/08.jpg">
								<div class="card card-element-hover card-overlay-hover overflow-hidden">
									<img src="<?php echo site_url('yachtProject/'); ?>assets/images/yacht_laurent/08.jpg"
										class="rounded-3" alt="Book My Yacht">
									<div class="hover-element w-100 h-100">
										<i
											class="bi bi-fullscreen fs-6 text-white position-absolute top-50 start-50 translate-middle bg-dark rounded-1 p-2 lh-1"></i>
