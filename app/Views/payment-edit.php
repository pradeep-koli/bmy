                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18 mx-4">Payment</h4>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 col-lg-8">
                                        ...
                                        <form method="post" class="py-5" action="<?= base_url('payment/update' .$paymentEdit['id']); ?>">

                                            <?= csrf_field() ?>

                                            <div class="row mb-4">
                                                <input type="text" name="bankName" value="<?= $paymentEdit['bankName']; ?>" class="form-control" placeholder="Bank Name">
                                            </div>

                                            <div class="row mb-4">
                                                <input type="text" name="bankAddress" value="<?= $paymentEdit['bankAddress']; ?>" class="form-control" placeholder="Bank Address">
                                            </div>

                                            <div class="row mb-4">
                                                <input type="text" name="ABA" value="<?= $paymentEdit['ABA']; ?>" class="form-control" placeholder="Routing (ABA)">
                                            </div>

                                            <div class="row mb-4">
                                                <input type="text" name="swiftCode" value="<?= $paymentEdit['swiftCode']; ?>" class="form-control" placeholder="SWIFT Code">
                                            </div>

                                            <div class="row mb-4">
                                                <input type="text" name="IBAN" value="<?= $paymentEdit['IBAN']; ?>" class="form-control" placeholder="IBAN">
                                            </div>

                                            <div class="row mb-4">
                                                <input type="text" name="accountNumber" value="<?= $paymentEdit['accountNumber']; ?>" class="form-control" placeholder="Account number">
                                            </div>

                                            <div class="row mb-4">
                                                <input type="text" name="accountType" value="<?= $paymentEdit['accountType']; ?>" class="form-control" placeholder="Account type">
                                            </div>

                                            <div class="row mb-4">
                                                <input type="text" name="beneficiaryName" value="<?= $paymentEdit['beneficiaryName']; ?>" class="form-control" placeholder="Beneficiary name">
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4">
                                        <!-- just arject for column so empty this column -->
                                    </div> 
