...
<!-- Mirrored from themesdesign.in/dason-django/layouts/default/tables-responsive.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Feb 2024 22:11:39 GMT -->
<head>
        
        <meta charset="utf-8" />
        <title>Responsive Tables | Dason - Admin & Dashboard Template</title>
    ...
    <!-- <body data-layout="horizontal"> -->
        ...
        <!-- Responsive Table js -->
        <script src="<?php echo site_url('public/');?>assets/libs/admin-resources/rwd-table/rwd-table.min.js"></script>

        <!-- Init js -->
        <script src="<?php echo site_url('public/');?>assets/js/pages/table-responsive.init.js"></script>
