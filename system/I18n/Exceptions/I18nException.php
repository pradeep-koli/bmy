...
class I18nException extends FrameworkException
{
     ...
     * @return static
     */
    public static function forInvalidDay(string $record)
    {
        return new static(lang('Time.invalidDay', [$record]));
    }
     ...
     * @return static
     */
    public static function forInvalidOverDay(string $lastDay, string $record)
    {
        return new static(lang('Time.invalidOverDay', [$lastDay, $record]));
    }
